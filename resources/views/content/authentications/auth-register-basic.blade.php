  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
      <div class="w-px-400 mx-auto mt-12 pt-5">
        ...
        <!-- Headings for the registration form page -->
        ...
        <form id="formAuthentication" class="mb-6" action="{{ route('register') }}" method="POST">
          @csrf <!-- Laravel directive to insert CSRF token for security against cross-site request forgery -->
          ...
          <div class="mb-6">
            ...
            @error('name') <!-- Display validation error for 'name' field -->
          ...
          <div class="mb-6">
            ...
            <select class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender">
              ...
              <!-- Preselect the option if there's old input -->
          ...
          <div class="mb-6">
            ...
            <select class="form-control @error('blood_type') is-invalid @enderror" id="blood_type" name="blood_type">
              ...
              <!-- Blood types with conditionally selected value -->
